...
const FbSignIn = () => {
  ...
  const handleLoginSuccess = (response) => {
    console.log("Login Success. Redirecting to Dashboard:", response);
    navigate("/dashboard");
  };
  ...
  return (
    <div className="flex justify-center items-center mt-2">
      {/* Custom button design for Facebook login */}
      <LoginSocialFacebook
        appId="8682797421779361"
        onResolve={handleLoginSuccess}
        onReject={handleLoginFailure}
      >
        <button className="bg-blue-600 text-white text-center text-sm p-2 rounded flex items-center justify-center hover:bg-blue-700">
